...
public interface Constants {
    ...
    String URL = "http://toplista.gline.webd.pl/gen_xml_lista.php?lang=LANG&groupid=3";
	String URL_2012 = "http://toplista.gline.webd.pl/gen_xml_notowania.php?lang=LANG&groupid=3&notowanieid=START_NOTOWANIE_ID";
	//public final String URL_SWIATECZNE = "http://toplista.gline.webd.pl/gen_xml_lista.php?lang=LANG&groupid=2";
	...
	String UTWORY_WYK_URL = "http://toplista.gline.webd.pl/gen_xml_utw_wyk.php?wyk_id=AUTH_ID&groupid=3";
