...
public class SpotifyBottomSheetController implements SpotifyService.SpotifyPlayerListener {
    ...
    private void setupListeners() {
        ...
        bottomSheetBehavior.addBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
                Log.d(TAG, "Bottom sheet state changed to " + getStateString(newState));
    ...
    public void showBottomSheet(boolean expanded) {
        ...
        bottomSheet.post(() -> {
            try {
                // Temporarily enable hideable if we need to transition from hidden state
                if (bottomSheetBehavior.getState() == BottomSheetBehavior.STATE_HIDDEN) {
                    ...
                    // Already visible, just change state
                    if (expanded) {
                        bottomSheetBehavior.setState(BottomSheetBehavior.STATE_EXPANDED);
                        Log.d(TAG, "Bottom sheet set to EXPANDED state");
                    } else {
